...
export function Hero() {
	...
	return (
		<section className="relative flex min-h-[100dvh] flex-col items-center justify-center px-6 py-32 pt-32 pb-12">
			...
			<div className="relative text-center max-w-3xl">
				...
				<div className="mt-8 flex items-center justify-center gap-3">
					<a
						href="#register"
						className="rounded-md bg-[var(--accent)] px-6 py-2.5 text-sm font-medium text-[var(--background)] transition-all hover:opacity-90 active:scale-95"
					>
						Register Now
					</a>
					{event.features.deck && (
						<a
							href="/deck"
							className="rounded-md border border-[var(--border)] px-6 py-2.5 text-sm font-medium text-[var(--muted)] transition-all hover:text-[var(--foreground)] hover:border-[var(--accent)]/30 active:scale-95"
						>
							Sponsor Deck
						</a>
					)}
